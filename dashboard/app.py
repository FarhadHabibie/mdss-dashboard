...
@media(max-width:700px){.stats-row{grid-template-columns:repeat(2,1fr)}.navbar{padding:0 16px}.wrap{padding:16px}.section{padding:16px 14px}.chart-card{padding:14px 12px}.charts-row{grid-template-columns:1fr;overflow:hidden}.chart-card{min-width:0}}
